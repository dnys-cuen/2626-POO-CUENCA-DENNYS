...
class Restaurante:
    ...
    Attributes:
        ...
        ventas (List[Venta]): Lista de ventas realizadas.
    ...
    def obtener_ventas_usuario(self, identificacion_usuario: str) -> List[Venta]:
        ...
        Recorre la colección de ventas y filtra por identificación del usuario.

        Args:
            identificacion_usuario (str): Identificación del usuario.

        Returns:
            List[Venta]: Lista de ventas del usuario.
        """
    ...
    def cargar_datos_desde_archivo(self) -> bool:
        ...
        Reemplaza las colecciones actuales.
