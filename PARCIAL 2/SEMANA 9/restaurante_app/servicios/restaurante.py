...
Incluye capacidad de persistencia de datos en archivos JSON.
"""

from typing import List
from modelos.producto import Producto
from modelos.cliente import Cliente
from servicios.persistencia_json import PersistenciaJSON
...
class Restaurante:
    ...
    def __init__(self) -> None:
        ...
        Inicializa el gestor de persistencia JSON.
        """
    ...
    def registrar_producto(self, producto: Producto) -> bool:
        ...
        Guarda automáticamente en JSON después de registrar.
        ...
        self.persistencia.guardar_productos(self.productos)
        return True
    ...
    def registrar_cliente(self, cliente: Cliente) -> bool:
        ...
        self.persistencia.guardar_clientes(self.clientes)
        return True
    ...
    def guardar_datos(self) -> bool:
        """
        Guarda todos los productos y clientes en archivos JSON.
        Utiliza estructura diccionaria para mejor organización.

        Returns:
            bool: True si ambos guardados fueron exitosos, False en caso contrario.
        """
        resultado_productos = self.persistencia.guardar_productos(self.productos)
        resultado_clientes = self.persistencia.guardar_clientes(self.clientes)
        return resultado_productos and resultado_clientes
    ...
    def cargar_datos(self) -> bool:
        ...
        """
        try:
            self.productos = self.persistencia.cargar_productos()
